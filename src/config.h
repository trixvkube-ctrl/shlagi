...
struct LogicConfig {
  ...
  uint32_t open_pulse_ms = 800;
  uint32_t open_timeout_ms = 15000;
  uint32_t open_hold_time_ms = 2000;
  uint32_t close_timeout_ms = 25000;
  uint32_t extra_wait_before_retry_ms = 1500;
  ...
  bool auto_recover_from_error = true;
};

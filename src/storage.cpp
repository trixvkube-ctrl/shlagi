...
bool Storage::load(AppConfig& cfg) {
  ...
  cfg.logic.relay_invert = doc["logic"]["relay_invert"] | cfg.logic.relay_invert;
  ...
  cfg.logic.dual_limit_error_ms = doc["logic"]["dual_limit_error_ms"] | cfg.logic.dual_limit_error_ms;
...
bool Storage::save(const AppConfig& cfg) {
  ...
  doc["logic"]["relay_invert"] = cfg.logic.relay_invert;
  ...
  doc["logic"]["dual_limit_error_ms"] = cfg.logic.dual_limit_error_ms;
